...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      axios.get(`http://34.128.90.223:4000/api/graph/rumahstats${startDate != '' & endDate != '' ? `?startDate=${startDate}&endDate=${endDate}`  : ""}`,
      {
        headers: {
      ...
      const countRumah = await axios.get(`http://34.128.90.223:4000/api/graph/rumah${startDate != '' & endDate != '' ? `?startDate=${startDate}&endDate=${endDate}`  : ""}`);
      const countDakwah = await axios.get(`http://34.128.90.223:4000/api/graph/petadakwah${startDate != '' & endDate != '' ? `?startDate=${startDate}&endDate=${endDate}`  : ""}`);
      const countMasjid = await axios.get(`http://34.128.90.223:4000/api/graph/masjid${startDate != '' & endDate != '' ? `?startDate=${startDate}&endDate=${endDate}`  : ""}`);

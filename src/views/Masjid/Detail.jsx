      ...
      {({
        ...
        <Form onSubmit={handleSubmit}>
          <FormControl isRequired >
            ...
            <Input name="namaMasjid" onChange={handleChange} value={values?.namaMasjid ? values.namaMasjid : "" } disabled/>
          </FormControl>
          <FormControl isRequired mt="4" >
            <FormLabel>Ketua DKM</FormLabel>  
            <Input name="ketuaDKM" onChange={handleChange} value={values?.ketuaDKM ? values.ketuaDKM : "" } disabled/>
          </FormControl>
          <FormControl isRequired mt="4" >
            <FormLabel>Tahun Berdiri</FormLabel>  
            <Input type="number" name="tahunBerdiri" onChange={handleChange} value={values?.tahunBerdiri ? values.tahunBerdiri : "" } disabled/>
          </FormControl>
          <FormControl isRequired mt="4" >
            <FormLabel>Jumlah Jamaah</FormLabel>  
            <Input type="number" name="jumlahJamaah" onChange={handleChange} value={values?.jumlahJamaah ? values.jumlahJamaah : "" } disabled/>
          </FormControl>
          <FormControl isRequired mt="4" >

...
export default function Sidebars({mapRef }) {
    ...
    const fetchData = async () => {
        try {
            const rumahAll = await axios.get('http://34.128.90.223:4000/api/admin/rumah');
            const rumahKurban = await axios.get('http://34.128.90.223:4000/api/rumah/kurban/true');
            const rumahHaji = await axios.get('http://34.128.90.223:4000/api/rumah/haji/true');
            const rumahZakat = await axios.get('http://34.128.90.223:4000/api/rumah/zakat/true');
            const petaDakwah = await axios.get('http://34.128.90.223:4000/api/petadakwah');
            const petaMasjid = await axios.get('http://34.128.90.223:4000/api/masjid');
            const graphRumahStats = await axios.get('http://34.128.90.223:4000/api/graph/rumahstats');
            const countRumah = await axios.get('http://34.128.90.223:4000/api/graph/rumah');
            const countDakwah = await axios.get('http://34.128.90.223:4000/api/graph/petadakwah');
            const countMasjid = await axios.get('http://34.128.90.223:4000/api/graph/masjid');
